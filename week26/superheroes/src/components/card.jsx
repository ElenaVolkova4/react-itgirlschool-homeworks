...
const heroes = JSON.parse(json);//парсим героев (переводим в объект)
...
<div className='pic'>
<img className="img" alt="picture" src='${hero.pic}' /> </div>
        <div class='rightSide'>
<h2>${hero.heroName}</h2>
<div className='title'>Альтер эго: <span>${hero.alterEgo}</span></div>
<div className='title'>Вселенная: <span>${hero.universe}</span></div>
<div className='title'>Суперсилы: <span>${hero.superPower}</span></div>
<div className='title'>Подробнее: <span>${hero.details}</span></div>
</div></div></div>
 */}
